...
export type ScanStatus = "Reviewed" | "Pending review" | "Referred";
...
const seedRows: [string, string, string, string, string, Severity, number, boolean, ScanStatus][] = [
  ["WF-24041", "Rice", "Rice bacterial leaf blight", "Cuttack", "Odisha", "moderate", 0.84, true, "Referred"],
  ["WF-24040", "Rice", "Rice bacterial leaf blight", "Kendrapara", "Odisha", "moderate", 0.79, false, "Pending review"],
  ["WF-24039", "Wheat", "Wheat leaf rust", "Karnal", "Haryana", "high", 0.91, true, "Referred"],
  ["WF-24038", "Potato", "Potato late blight", "Darjeeling", "West Bengal", "high", 0.88, false, "Referred"],
  ...
  ["WF-24029", "Rice", "Rice bacterial leaf blight", "Puri", "Odisha", "moderate", 0.81, true, "Referred"],
  ...
  ["WF-24026", "Potato", "Potato late blight", "Hooghly", "West Bengal", "high", 0.86, true, "Referred"],
  ...
  ["WF-24021", "Wheat", "Wheat leaf rust", "Meerut", "Uttar Pradesh", "moderate", 0.83, true, "Referred"],
  ["WF-24020", "Maize", "Healthy", "Amritsar", "Punjab", "low", 0.93, true, "Reviewed"],
  ["WF-24019", "Potato", "Potato late blight", "Agra", "Uttar Pradesh", "high", 0.89, false, "Referred"],
  ["WF-24018", "Tomato", "Unknown", "Patna", "Bihar", "low", 0.47, false, "Pending review"],
  ["WF-24017", "Rice", "Rice bacterial leaf blight", "Ganjam", "Odisha", "moderate", 0.82, true, "Referred"],
  ...
  ["WF-24012", "Maize", "Maize fall armyworm damage", "Nizamabad", "Telangana", "moderate", 0.75, false, "Referred"],
  ...
  ["WF-24007", "Rice", "Rice bacterial leaf blight", "Cuttack", "Odisha", "moderate", 0.8, false, "Referred"],
  ...
  ["WF-24001", "Tomato", "Tomato early blight", "Pune", "Maharashtra", "moderate", 0.76, false, "Referred"],
];

export const scans: Scan[] = seedRows.map(([id, crop, condition, district, state, severity, confidence, verified, status], index) => ({
  id, crop, condition, farmer: index === 0 ? "S. Pradhan" : `Farmer ${String.fromCharCode(65 + (index % 20))}`, district, state, severity, confidence, verified, status, date: `2025-${String(3 + Math.floor(index / 12)).padStart(2, "0")}-${String(3 + (index % 24)).padStart(2, "0")}`, referral: status === "Referred" ? "Suggested" : "None", imageQuality: confidence > .7 ? "Good" : confidence > .5 ? "Fair" : "Poor",
}));

export const recentScans = scans.slice(0, 5);
export const centers = [
  { id: "vc-01", name: "Odisha Crop Health Centre", district: "Cuttack", state: "Odisha", distance: "18 km", capability: "Rice disease microscopy · field visit", contact: "+91 671 244 0188" },
  { id: "vc-02", name: "Regional Plant Clinic, Bhubaneswar", district: "Khordha", state: "Odisha", distance: "62 km", capability: "Bacterial & fungal diagnostics", contact: "+91 674 239 4102" },
  { id: "vc-03", name: "Karnal Field Diagnostic Unit", district: "Karnal", state: "Haryana", distance: "12 km", capability: "Wheat & cereal disease survey", contact: "+91 184 226 9021" },
];
export const weather = { location: "Cuttack district (approx.)", temperature: "29°C", humidity: "78%", rain: "7.4 mm", wind: "11 km/h", source: "Demo weather", updated: "Today, 08:40 IST" };
...
export const referrals = [
  { id: "RF-1082", scan: "WF-24041", district: "Cuttack", target: "Odisha Crop Health Centre", status: "Suggested", distance: "18 km", capability: "Rice disease microscopy" },
  { id: "RF-1078", scan: "WF-24039", district: "Karnal", target: "Karnal Field Diagnostic Unit", status: "In progress", distance: "12 km", capability: "Wheat & cereal disease survey" },
  { id: "RF-1071", scan: "WF-24038", district: "Darjeeling", target: "North Bengal Plant Clinic", status: "Assigned", distance: "34 km", capability: "Potato late blight" },
  { id: "RF-1063", scan: "WF-24029", district: "Puri", target: "Odisha Crop Health Centre", status: "Verified", distance: "49 km", capability: "Rice disease microscopy" },
];
export const allIndiaSummary = { reports: 412, farms: 286, high: 9, moderate: 21, low: 7, pending: 26 };
export const report = { title: "Crop-health pulse · March 2025", generated: "31 Mar 2025 · 16:20 IST", summary: "Rice and wheat signals increased in the eastern and northern belts during a humid fortnight. Cuttack remains a watch district: recent reports are clustered but laboratory confirmation is still limited.", rankings: ["Karnal · High · 14 reports", "Darjeeling · High · 12 reports", "Cuttack · Moderate · 18 reports", "Kolar · Moderate · 8 reports"] };
export const retraining = { last: "18 Mar 2025 · 02:10 IST", verified: 27, changed: 64, skipped: 1_284, candidate: "0.78 macro F1", current: "0.74 macro F1", next: "18 Apr 2025", status: "Candidate review" };
