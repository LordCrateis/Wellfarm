...
export function Login() {
  ...
  return <main className="h-[100dvh] overflow-hidden bg-background px-5 py-[clamp(1.25rem,3vh,2.5rem)]"><div className="mx-auto flex h-full max-w-6xl flex-col"><div className="shrink-0"><Brand /></div>
    <div className="grid min-h-0 flex-1 items-center gap-12 lg:grid-cols-2 lg:gap-24">
      ...
      <section className="mx-auto w-full max-w-xl rounded-2xl border bg-card p-[clamp(1.25rem,3vh,2.25rem)] shadow-sm"><h2 className="text-3xl">{verification ? "Check your inbox" : register ? "Create your account" : "Welcome back"}</h2><p className="mt-2 text-sm text-muted-foreground">{verification ? `Enter the verification code sent to ${email}.` : register ? "A place for your fields, photos and observations." : "Sign in to pick up where you left off."}</p>
