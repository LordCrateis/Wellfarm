...
const allowedOrigins = [process.env.APP_ORIGINS, process.env.APP_ORIGIN, process.env.FRONTEND_URL]
...
app.use((req, res, next) => {
  ...
  if (!["GET", "HEAD", "OPTIONS"].includes(req.method) && origin && !allowed.includes(normalizeOrigin(origin))) {
